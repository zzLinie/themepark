...
const GiftShopForm = () => {
  ...
  const fetchShops = async () => {
    try {
      const response = await axios.get(
        "https://themepark-backend.onrender.com/shops/read"
      );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (isEditMode) {
        await axios.put(
          `https://themepark-backend.onrender.com/shops/${formData.shopID}`,
          formData
        );
      } else {
        await axios.post(
  ...
  const handleDelete = async (shopID) => {
    if (window.confirm("Are you sure you want to delete this shop?")) {
      try {
        await axios.delete(
          `https://themepark-backend.onrender.com/shops/${shopID}`
        );
        fetchShops();
      } catch (error) {
