  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const parkStatusRes = await axios.get(
          "http://localhost:5000/parkstatuses"
        );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:5000/specialevents",
        eventData
      );
